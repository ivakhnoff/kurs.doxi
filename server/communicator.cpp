...
int communicator::connection(int port, std::map<std::string, std::string> base, logger* l)
{
    try {
        ...
        if (s <= 0) {
            ...
            std::cout << "Сокет создан" << std::endl; // Вывод в консоль
        }
        ...
        if (rc == -1) {
            ...
            std::cout << "Привязка сокета успешна" << std::endl; // Вывод в консоль
        }
        ...
        for (;;) {
            try {
                ...
                std::cout << "Пакет от клиента получен" << std::endl; // Вывод в консоль
                buff[rc] = 0;
                ...
                std::cout << "Ответ 'OK' отправлен клиенту" << std::endl; // Вывод в консоль
                ...
                std::cout << "Количество векторов получено" << std::endl; // Вывод в консоль
                for (int i = 0; i < count; i++) {
                    ...
                    std::cout << "Результат отправлен" << std::endl; // Вывод в консоль
                }
                ...
                l->writelog(e.what());
                std::cout << e.what() << std::endl; // Вывод в консоль
            }
        }
    } catch (crit_err& e) {
        l->writelog(e.what());
